...
namespace Pre_Aceleracion_Julieta_Sosa
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                //cada vez que se envie el token, qué queremos validar de ese token 
                options.TokenValidationParameters = new TokenValidationParameters
                {
                    ValidateIssuer = true,
                    ValidateAudience = true,
                    ValidateLifetime = true, //solo seran validos los tokens que no se hayan vencido
                    ValidateIssuerSigningKey = true, //que sea la misma que se genero
